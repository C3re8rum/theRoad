...
// Import Modules
import { TheRoadActor } from "./actor.js";
import { TheRoadItem } from "./item.js";
import { TheRoadItemSheet } from "./item-sheet.js";
import { TheRoadActorSheet } from "./actor-sheet.js";
import { preloadHandlebarsTemplates } from "./templates.js";
import { createWorldbuildingMacro } from "./macro.js";
import { TheRoadToken, TheRoadTokenDocument } from "./token.js";
...
Hooks.once("init", async function () {
    ...
    CONFIG.Actor.documentClass = TheRoadActor;
    CONFIG.Item.documentClass = TheRoadItem;
    CONFIG.Token.documentClass = TheRoadTokenDocument;
    CONFIG.Token.objectClass = TheRoadToken;

    // Register sheet application classes
    Actors.unregisterSheet("core", ActorSheet);
    Actors.registerSheet("worldbuilding", TheRoadActorSheet, { makeDefault: true });
    Items.unregisterSheet("core", ItemSheet);
    Items.registerSheet("worldbuilding", TheRoadItemSheet, { makeDefault: true });
